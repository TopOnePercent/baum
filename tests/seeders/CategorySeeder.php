...
class OrderedScopedCategorySeeder {
    ...
    public function run() {
        ...
        OrderedScopedCategory::create(array('id' => 2 , 'company_id' => 1, 'name' => 'Child 1'  , 'lft' => 2, 'rgt' => 3 , 'depth' => 1, 'parent_id' => 1));
        ...
        OrderedScopedCategory::create(array('id' => 5 , 'company_id' => 1, 'name' => 'Child 3'  , 'lft' => 8, 'rgt' => 9 , 'depth' => 1, 'parent_id' => 1));
